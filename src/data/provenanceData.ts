...
export const PROVENANCE_SOURCES: Record<string, ProvenanceCitation> = {
  TIER1_FINANCIAL: {
    sourceTier: 'TIER 1',
    sourceName: 'Dữ liệu nội bộ (data-brocoli_6m2026_vs_dec2025)',
    sourceFile: 'data_brocoli - 6m2026_vs_dec_2025.csv (Dữ liệu nội bộ)',
    citationLabel: 'Nguồn: Dữ liệu nội bộ (data-brocoli_6m2026_vs_dec2025)',
  ...
  TIER2_WEBSITE: {
    ...
    sourceFile: 'data_brocoli - webstie_securities.csv (Dữ liệu nội bộ)',
  ...
  TIER3_TAX: {
    ...
    sourceFile: 'data_brocoli - tax2023_2025.csv (Dữ liệu nội bộ)',
  ...
  TIER3_UX: {
    ...
    sourceFile: 'data_brocoli - other_sources.csv (Dữ liệu nội bộ)',
    citationLabel: 'Nguồn: Dữ liệu nội bộ & Biểu phí công bố chính thức của CTCK',
